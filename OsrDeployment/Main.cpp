...
#include <OsrDeployment/Top/OsrDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    OsrDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    OsrDeployment::TopologyState inputs;
    ...
    OsrDeployment::setupTopology(inputs);
    OsrDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    OsrDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
