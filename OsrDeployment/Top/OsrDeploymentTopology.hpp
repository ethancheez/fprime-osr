// ======================================================================
// \title  OsrDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef OSRDEPLOYMENT_OSRDEPLOYMENTTOPOLOGY_HPP
#define OSRDEPLOYMENT_OSRDEPLOYMENTTOPOLOGY_HPP
// Included for access to OsrDeployment::TopologyState and OsrDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <OsrDeployment/Top/OsrDeploymentTopologyDefs.hpp>

// Remove unnecessary OsrDeployment:: qualifications
using namespace OsrDeployment;
namespace OsrDeployment {
/**
 ...
 * OsrDeployment::TopologyState see: OsrDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type OsrDeployment::TopologyState see: OsrDeploymentTopologyDefs.hpp.
 *
