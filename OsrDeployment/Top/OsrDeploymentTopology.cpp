// ======================================================================
// \title  OsrDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <OsrDeployment/Top/OsrDeploymentTopologyAc.hpp>
#include <OsrDeployment/Top/OsrDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(OsrDeploymentPacketsPkts, OsrDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name OsrDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        OsrDeployment::blockDrv.callIsr();
